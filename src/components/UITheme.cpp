...
#include "components/themes/cascade/CascadeTheme.h"
...
void UITheme::setTheme(CrossPointSettings::UI_THEME type) {
  switch (type) {
    ...
    case CrossPointSettings::UI_THEME::LYRA_3_COVERS:
      ...
      break;
    case CrossPointSettings::UI_THEME::CASCADE:
      LOG_DBG("UI", "Using Cascade theme");
      currentTheme = std::make_unique<CascadeTheme>();
      currentMetrics = &CascadeMetrics::values;
      break;
  }
}
